...
var pacs008_511_qrcode = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<Envelope xmlns="https://www.bcb.gov.br/pi/pacs.008/1.14">
    <AppHdr>
        <Fr>
            <FIId>
    ...
    <Document>
        <FIToFICstmrCdtTrf>
            ...
            <CdtTrfTxInf>
                <PmtId>
                    <EndToEndId>%s</EndToEndId>
					<TxId>4d181c3c80d1472aa73dff58f</TxId>
                </PmtId>
                <IntrBkSttlmAmt Ccy="BRL">%s</IntrBkSttlmAmt>
                <AccptncDtTm>%s</AccptncDtTm>
                <ChrgBr>SLEV</ChrgBr>
...
var pacs008_511_qrcode_estatico_saque = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<Envelope xmlns="https://www.bcb.gov.br/pi/pacs.008/1.14">
    <AppHdr>
        <Fr>
            <FIId>
...
var pacs008_511_qrcode_dinamico_saque = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<Envelope xmlns="https://www.bcb.gov.br/pi/pacs.008/1.14">
    <AppHdr>
        <Fr>
            <FIId>
    ...
    <Document>
        <FIToFICstmrCdtTrf>
            ...
            <CdtTrfTxInf>
                <PmtId>
                    <EndToEndId>%s</EndToEndId>
					<TxId>45b03d026e454c419a9897e8433e2623</TxId>
                </PmtId>
                <IntrBkSttlmAmt Ccy="BRL">%s</IntrBkSttlmAmt>
                <AccptncDtTm>%s</AccptncDtTm>
                <ChrgBr>SLEV</ChrgBr>
                ...
                <RmtInf>
					...
					<Strd>
                        ...
                        <RfrdDocAmt>
                            <AdjstmntAmtAndRsn>
                                <Amt Ccy="BRL">155.11</Amt>
                                <Rsn>VLCP</Rsn>
                            </AdjstmntAmtAndRsn>
                            <AdjstmntAmtAndRsn>
                                <Amt Ccy="BRL">443.92</Amt>
                                <Rsn>VLDN</Rsn>
                            </AdjstmntAmtAndRsn>
                        </RfrdDocAmt>
                    </Strd>
...
func GeneratePacs008Manual(ispb, account, branch, document, accountType, amount, message string) string {
	now := getCurrentTime().UTC()
	endToEndID, _ := GenerateEndToEndId("52833288", now)
	id, _ := GenerateMsgId("52833288")
...
func GeneratePacs008Dict(ispb, account, branch, document, accountType, amount, message, key string) string {
	...
	ready := fmt.Sprintf(
		//pacs008_511_dict,
		//pacs008_511_qrcode,
		//pacs008_511_qrcode_estatico_saque,
		pacs008_511_qrcode_dinamico_saque,
		id,
		now.Format("2006-01-02T15:04:05.000Z"),
		id, now.Format("2006-01-02T15:04:05.000Z"),
		endToEndID,
